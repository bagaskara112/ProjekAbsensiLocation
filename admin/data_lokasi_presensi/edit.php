...
if (isset($_POST['update'])) {
    ...
    $nama_lokasi = isset($_POST['nama_lokasi']) ? htmlspecialchars($_POST['nama_lokasi']) : null;
    $alamat_lokasi = isset($_POST['alamat_lokasi']) ? htmlspecialchars($_POST['alamat_lokasi']) : null;
    $tipe_lokasi = isset($_POST['tipe_lokasi']) ? htmlspecialchars($_POST['tipe_lokasi']) : null;
    ...
    $radius = isset($_POST['radius']) ? htmlspecialchars($_POST['radius']) : null;
    $zona_waktu = isset($_POST['zona_waktu']) ? htmlspecialchars($_POST['zona_waktu']) : null;
    $jam_masuk = isset($_POST['jam_masuk']) ? htmlspecialchars($_POST['jam_masuk']) : null;
    $jam_pulang = isset($_POST['jam_pulang']) ? htmlspecialchars($_POST['jam_pulang']) : null;
