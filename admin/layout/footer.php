        ...
        <div class="row text-center align-items-center flex-row-reverse">
            <div class="col-lg-auto ms-lg-auto">
                <ul class="list-inline list-inline-dots mb-0">
                    <li class="list-inline-item">
                        <a href="https://www.instagram.com/hmpti_unisba?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="link-secondary" rel="noopener">
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                    <li class="list-inline-item">
                        Copyright &copy; 2024
                        <a href="" class="link-secondary">Bagaskara</a>.
                        All rights reserved.
                    </li>
                    <li class="list-inline-item">
...
<script src="<?= base_url('assets/jsvectormap/dist/maps/world.js?1692870487') ?>" defer></script>
<script src="<?= base_url('assets/jsvectormap/dist/maps/world-merc.js?1692870487') ?>" defer></script>
...
<?php if (!empty($_SESSION['validasi'])) : ?>
    <script>
