    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($_FILES['foto_baru']['error'] != 4) {
            ...
            if (!in_array(strtolower($ambil_ekstensi), $ekstensi_diizinkan)) {
                $pesan_kesalahan[] = "<i class='fa-solid fa-check'></i> Hanya file dengan ekstensi jpg, jpeg, dan png yang diizinkan";
            }
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="">Ulangi Pasword</label>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="lokasi_presensi" class="form-control">
                                    ...
                                    while ($roww = mysqli_fetch_assoc($ambil_lok_presensi)) {
                                        $nama_lokasi = $roww['nama_lokasi'];
